...
function withinMaxClamp2(min3, value, max3) {
  var v2 = within2(min3, value, max3);
  return v2 > max3 ? max3 : v2;
}
    ...
    [].concat(Object.keys(modifier), VALID_PROPERTIES2).filter(function(value, index, self) {
      ...
      switch (key) {
        ...
        case "data":
          break;
        default:
          console.error('PopperJS: an invalid property has been provided to the "' + modifier.name + '" modifier, valid properties are ' + VALID_PROPERTIES2.map(function(s2) {
            return '"' + s2 + '"';
          }).join(", ") + '; but "' + key + '" was provided.');
      }
      modifier.requires && modifier.requires.forEach(function(requirement) {
...
var me = function(n2) {
  var a2 = n2.children, r2 = n2.isOpen, l2 = void 0 !== r2 && r2, o2 = n2.options, c2 = n2.animation, i2 = void 0 === c2 || c2, s2 = n2.dropup, d = n2.dropright, u2 = n2.dropleft, m2 = n2.onHide, g2 = n2.onShow, h2 = (0, import_react.useState)(l2), b2 = h2[0], N2 = h2[1], w2 = (0, import_react.useState)(null), y2 = w2[0], E2 = w2[1], k2 = (0, import_react.useState)(null), x2 = k2[0], C2 = k2[1], T2 = (0, import_react.useState)(-1), R2 = T2[0], S2 = T2[1], P2 = usePopper(y2, x2, v({ placement: s2 ? "top-start" : d ? "right-start" : u2 ? "left-start" : "bottom-start", modifiers: [flip_default2] }, o2)).styles;
